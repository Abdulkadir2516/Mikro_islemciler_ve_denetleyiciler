...
MODEL                   = ornek1
MODULES                 = ornek1_main.c
#MODULES_OBJ            = ornek1_main.obj 
#PRODUCT                 = $(RELATIVE_PATH_TO_ANCHOR)/ornek1.exe
MAKEFILE                = ornek1.mk
MATLAB_ROOT             = G:/Programs
ALT_MATLAB_ROOT         = G:/Programs
MASTER_ANCHOR_DIR       = 
START_DIR               = C:/Users/yesil/Desktop/yeni
S_FUNCTIONS             = 
S_FUNCTIONS_LIB         = 
NUMST                   = 1
NCSTATES                = 0
COMPUTER                = PCWIN64
BUILDARGS               =  GENERATE_ASAP2=0 MCHP_AUTO_FLASH=0 MCHP_MULTITHREAD_COMPILATION=0 LinkWithMaster=0 OPTS="-DTID01EQ=0 -mdfp=G:/Programs/A/packs/Microchip/dsPIC33F-GP-MC_DFP/1.3.64/xc16"
MULTITASKING            = 0
INTEGER_CODE            = 0
MAT_FILE                = 0
ALLOCATIONFCN           = 0
...
MODELLIB                  = 
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = ornek1_ref.rsp
MODELREF_INC_PATH         = 
